...
const inputTypes = {
  ...
  outline: {
    ...
    hasErrorSpecificClassnames: '',
    labelSpecificClassnames:
      '-translate-y-4 top-2 bg-white start-1 px-2 peer-focus:px-2 peer-placeholder-shown:-translate-y-[10%] peer-placeholder-shown:top-[10%] peer-focus:top-2 peer-focus:-translate-y-4',
    inputSpecificClassnames:
    ...
    <div>
      <div className="relative">
        <textarea
          ...
          id={id}
          className={twMerge(
            'peer block w-full appearance-none border-gray-400 text-sm h-40 text-black focus:border-sky-600 focus:outline-none focus:ring-0 resize-none',
